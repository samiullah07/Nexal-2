...
from utils.ghunt_email.people import Person
from typing import *
...
class PeoplePaHttp(GAPI):
    ...
    def people_lookup(self, as_client: httpx.Client, email: str, params_template="just_gaia_id") -> Tuple[bool, Person]:
        ...
        req =  self._query(as_client, verb, endpoint_name, base_url, params_templates[params_template], None, data_type)
        ...
        person._scrape(as_client, person_data)

        return True, person

    def people(self, as_client: httpx.Client, gaia_id: str, params_template="just_name") -> Tuple[bool, Person]:
        endpoint_name = inspect.currentframe().f_code.co_name
